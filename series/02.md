...
<details>
<summary>コード例: 02_distance_concentration.py</summary>
...
<details>
<summary>コード例: 02_highdim_orthogonality.py</summary>

```02_highdim_orthogonality.py
import matplotlib.pyplot as plt
import numpy as np
...
<details>
<summary>コード例: 02_word2vec_norm_frequency.py</summary>

```02_word2vec_norm_frequency.py
import matplotlib.pyplot as plt
import numpy as np
