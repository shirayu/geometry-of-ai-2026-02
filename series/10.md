...
$$P(\mathbf{x} _1, \ldots, \mathbf{x} _T, \mathbf{z} _1, \ldots, \mathbf{z} _T) = P(\mathbf{z} _1) \prod _{t=2}^{T} P(\mathbf{z} _t | \mathbf{z} _{t-1}) \prod _{t=1}^{T} P(\mathbf{x} _t | \mathbf{z} _t)$$
...
$$\hat{x} _t = \arg\max _{x} P(x | \mathbf{x} _{1:t-1})$$
